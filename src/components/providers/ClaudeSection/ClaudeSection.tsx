    ...
    configs.forEach((config, index) => {
      ...
      cache.set(
        ...
        statusBarDataFromRecentRequests(
          collectProviderKeyConfigRecentBuckets('claude', config, usageByProvider)
        )
      );
    });
      ...
      <Card
        title={
          <ProviderSectionCardTitle
            icon={<img src={iconClaude} alt="" className={styles.cardTitleIcon} />}
      ...
      >
        {viewMode === 'table' ? (
          <ProviderKeyConfigTable
            ...
            itemTitle={t('ai_providers.claude_item_title')}
          ...
          <ProviderList<ProviderKeyConfig>
            ...
            renderContent={(item, index) => {
              const stats = getProviderKeyConfigRecentStats('claude', item, usageByProvider);
                ...
                <Fragment>
                  ...
                  {item.models?.length ? (
                    <ProviderModelsPreview
                      ...
                      modalTitle={`${t('ai_providers.claude_item_title')} #${index + 1}`}
                    />
                  ) : null}
