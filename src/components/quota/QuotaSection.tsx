...
export function QuotaSection<TState extends QuotaStatusState, TData>({
  ...
  const prevGlobalRefreshTriggerRef = useRef(globalRefreshTrigger);

  useEffect(() => {
    if (
      globalRefreshTrigger !== undefined &&
      globalRefreshTrigger !== prevGlobalRefreshTriggerRef.current
    ) {
      prevGlobalRefreshTriggerRef.current = globalRefreshTrigger;
